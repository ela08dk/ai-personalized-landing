    ...
    <section className="section-padding bg-gradient-to-b from-white to-craftera-blue/10">
      <div className="max-container">
        <div className="text-center mb-16">
          ...
          <h3 className="text-xl font-semibold text-craftera-dark mb-6">
            Try NewMode Right Now
          </h3>
          <div className="text-gray-600 space-y-2 mb-8">
            <p>Test our conversational AI editor on a live website</p>
            <p>See how different accounts would experience your site</p>
        ...
        <div className="relative rounded-xl overflow-hidden shadow-2xl border border-gray-100">
          <iframe
            src="https://dash.newmode.ai/proxy/brex.com"
